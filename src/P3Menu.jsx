...
const ITEMS = [
  ...
  { id: "resume",  label: "RESUME",        page: "resume",  fontSize: 84,  offsetX: 20, offsetY: 8,  skew: -11, skewY: -10 },
  { id: "github",  label: "GITHUB LINK",   page: "github",  fontSize: 86,  offsetX: 8,  offsetY: 6,  skew: 0,   skewY: -4  },
  { id: "socials", label: "SOCIALS",       page: "socials", fontSize: 94,  offsetX: 16, offsetY: 8,  skew: -3,  skewY: 5   },
  { id: "youtube", label: "YOUTUBE",       page: "youtube", fontSize: 88,  offsetX: 10, offsetY: 6,  skew: -4,  skewY: 7   },
];
