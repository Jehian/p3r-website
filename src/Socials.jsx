...
import bgVideo from "./assets/p3 reload quest menu no text loop.mp4";
...
const ITEMS = [
  {
    id: "twitch", label: "TWITCH", handle: "@halock09", href: "https://www.twitch.tv/halock09", icon: "🎮", barIcon: icon1, bars: 1, newBars: [0], counts: ["56"],
    links: ["www.twitch.tv/halock09"],
  },
  {
    id: "steam", label: "STEAM", handle: "zenix2s", href: "https://steamcommunity.com/id/zenix2s/", icon: "🎮", barIcon: icon2, bars: 1, newBars: [0], counts: ["128"],
    links: ["steamcommunity.com/id/zenix2s/"],
  },
  {
    id: "tiktok", label: "TIKTOK", handle: "@admetree", href: "https://www.tiktok.com/@admetree", icon: "🎵", barIcon: icon3, bars: 1, newBars: [0], counts: ["8.9K"],
    links: ["www.tiktok.com/@admetree"],
  },
];
...
export default function Socials() {
  ...
  useEffect(() => {
    const onKey = (e) => {
      if (focus === "left") {
        ...
        if (e.key === "Enter") {
          playSfx("deck_ui_launch_game");
          window.open("https://" + ITEMS[active].links[activeInfoBar], "_blank");
        }
      }
  ...
  return (
    <div id="menu-screen">
      ...
      <div className="sc-root" role="navigation" style={{ pointerEvents: "all" }}>
        {ITEMS.map((item, i) => (
          <div
            ...
            onMouseEnter={() => {
              if (active !== i) playSfx("deck_ui_misc_10");
              setActive(i);
            }}
          >
      ...
      {mounted && (
        <div className="sc-right-nav" key={active} style={{ pointerEvents: "all" }}>
          <span
      ...
      {mounted && Array.from({ length: ITEMS[active].bars }).map((_, i) => (
        <div
          ...
          key={`bar-${active}-${i}`}
          style={{ top: `${155 + i * 52}px`, animationDelay: `${i * 50}ms`, cursor: "pointer", pointerEvents: "all" }}
          onClick={() => {
            playSfx("deck_ui_launch_game");
            setActiveInfoBar(i);
            setFocus("right");
          ...
          onMouseEnter={() => {
            if (activeInfoBar !== i || focus !== "right") playSfx("deck_ui_misc_10");
            setActiveInfoBar(i);
            setFocus("right");
          }}
        >
